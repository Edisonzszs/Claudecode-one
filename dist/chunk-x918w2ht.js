...
var getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
  const { SSOOIDCClient } = await import("./chunk-janekkrk.js").then((m)=>__toESM(m.default,1));
...
var getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
  const { CreateTokenCommand } = await import("./chunk-janekkrk.js").then((m)=>__toESM(m.default,1));
