...
async function createBridgeSession({
  ...
  const { getClaudeAIOAuthTokens } = await import("./chunk-510ba9hj.js");
  const { getOrganizationUUID } = await import("./chunk-vr9b2jat.js");
  const { getOauthConfig } = await import("./chunk-jafes477.js");
  const { getOAuthHeaders } = await import("./chunk-qvc9h5qw.js");
  const { parseGitHubRepository } = await import("./chunk-q6av622g.js");
  const { getDefaultBranch } = await import("./chunk-3gqdqmzb.js");
  const { getMainLoopModel } = await import("./chunk-4jerfx5m.js");
  const { default: axios } = await import("./chunk-8hq5kk3y.js");
